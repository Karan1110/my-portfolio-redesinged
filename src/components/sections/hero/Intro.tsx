    ...
    <div className="flex flex-1 flex-col md:flex-row gap-7">
      ...
      <div className="flex flex-col justify-between flex-1 p-5 md:p-0">
        ...
        <div className="text-secondary text-sm mt-2 md:mt-0  max-w-[500px]">
          Join me Karan CS , on an exciting coding journey! Together, we&apos;ll
          delve into a world of knowledge, discover innovative ideas, embrace
          quick tips, master clever tricks, conquer coding challenges, implement
          best practices, and even tackle interview questions. Hit that follow
          button on if you&apos;ve not already done so and let&apos;s build
